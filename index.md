...
But the [`cdr()`](https://eliocamp.github.io/icecdr/reference/cdr.md)
...
The [`cdr_fix()`](https://eliocamp.github.io/icecdr/reference/fixes.md)
function will fix the grid information to make it work with
[CDO](https://code.mpimet.mpg.de/projects/cdo) and standardise variable
